...
public class EX_04_MapExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--- 1. Adding Elements (Key-Value Pairs) ---");
        ...
        System.out.println("Year of Camry: " + camryYear);

        // Check if a key exists
        boolean hasModel3 = carModelYears.containsKey("Model 3");
        System.out.println("Does the map contain 'Model 3'? " + hasModel3);
